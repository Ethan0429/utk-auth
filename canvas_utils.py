...
class StudentDashboard:
    def __init__(self):
        ...
        self.course_id = bot_vars.CONST_COSC102_COURSE_ID
    ...
    async def get_student_info(self, username):
        ...
        for assignment, submission in zip(assignments, submissions):
            ...
            assignment_data[
                "submission_url"] = f"https://utk.instructure.com/courses/{bot_vars.CONST_COSC102_COURSE_ID}/assignments/{assignment.id}/submissions/{data[student.id]}"
